...
I'm comfortable with Python, especially backend and API code. I want
practice diagnosing and fixing real bugs (error handling, input
validation, that kind of thing) rather than pure documentation edits.
I'd rather avoid heavy frontend/JS-heavy work for now.
